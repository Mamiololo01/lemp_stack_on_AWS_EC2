...
<?php
phpinfo();
You can now access this page in your web browser by visiting the domain name or public IP address you’ve set up in your Nginx configuration file, 
...
about your PHP environment and your Ubuntu server. You can use rm to remove that file:
